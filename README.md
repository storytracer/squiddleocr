...
| `--plots / --no-plots` | off | write `<name>.<suffix>.layout.jpg` next to the outputs: the page with regions (label, reading order, heading level), rows and page numbers drawn in |
